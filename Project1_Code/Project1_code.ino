...
const int BUTTON_ARDUINO_PIN[N_BUTTONS] = {6, 7}; //* pins of each button connected straigh to the Arduino
...
const int POT_ARDUINO_PIN[N_POTS] = {A5}; //* pins of each pot connected straigh to the Arduino
